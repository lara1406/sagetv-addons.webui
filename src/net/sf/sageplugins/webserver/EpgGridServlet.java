 ...
 *
 */
public class EpgGridServlet extends EpgServlet {
    
    /**
     * 
     */
    private static final long serialVersionUID = 1540260826042020682L;
    /* (non-Javadoc)
    ...
    throws Exception {
        ...
        try {
            ...
            for(int i=0;i<numhrs;i++) {
                ...
                if ( i==numhrs-1)
                    out.println("      <a href=\""+buildLink(req,0,numhrs,0)+"\" title=\"Later\"><img class=\"later\" alt=\"Arrow Right\" src=\"right.gif\"/></a>");
            ...
            for ( int i=0; i<channels.size(); i++){
                ...
                if ( i==0 && !(chlist!=null && chlist.length>0 ))
                    out.println("      <a href=\""+buildLink(req,0,0,-channels.size())+"\" title=\"page up\"><img class=\"pageup\" alt=\"Arrow Up\"  src=\"up.gif\"/></a>");
                if ( i==channels.size()-1 && !(chlist!=null && chlist.length>0 ))
                    out.println("      <a href=\""+buildLink(req,0,0,channels.size())+"\" title=\"page down\"><img class=\"pagedown\" alt=\"Arrow Down\" src=\"down.gif\"/></a>");
                ...
                for ( int j=0;j<SageApi.Size(airings);j++){
                    ...
                    // thiscellsize needed to be tweaked after adding hd and first run indicators
                    ...
                    if ( thiscellsize<=0){
                        ...
                        out.println("     <table class=\""+airing.getBgClassName(true)+" "+airing.getBorderClassName()+"\" "+
                                "style=\"width:"+Long.toString(thiscellsize)+"px;\" cellspacing=\"0\"><tr>\r\n");
                        ...
                        if ( airing.getWatched())
                            ...
                            out.print("     <div class=\"\"");
                        if (markHDTV || markFirstRuns) {
                            // if width is less than zero, ie will make the cell wide enough to show all text
    ...
    static final String[][] CELL_SIZE_OPTS=new String[][]{
        {"30","very small (30px/hr)"},
        {"60","small (60px/hr)"},
        {"120","medium (120px/hr)"},
        {"240","large (240px/hr)"},
        {"360","very large (360px/hr)"},
        {"480","huge! (480px/hr)"},
    };
}
