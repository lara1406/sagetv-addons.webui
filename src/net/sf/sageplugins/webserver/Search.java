...
public class Search
{
            ...
            if ( searchString !=null && searchString.length()>0){
                ...
                if ( isSearchTypeAirings() || isSearchTypeMediaFiles() || isSearchTypeTVFiles()) {
                    if (isExactTitle()){ 
                        ...
                        searchResults = SageApi.Api("SearchSelectedFields",new Object[]{
                                searchString,
                    ...
                    if (isSearchTypeMediaFiles() || isSearchTypeTVFiles()) {
                        ...
                        for ( int i=0;i<numres;i++)
                            newSearchResults=SageApi.Api("DataUnion",new Object[]{
                                    newSearchResults,
                                    SageApi.Api("GetMediaFileForAiring",SageApi.GetElement(searchResults,i))
                            });
                        
                        boolean tvFiles=isSearchTypeTVFiles();
                        /* filter only/out TV files */
                        searchResults = SageApi.Api("FilterByBoolMethod", new Object[] {
                                newSearchResults,
                                "IsTVFile",
                                new Boolean(tvFiles)});
                        if ( tvFiles ) {
    ...
    throws InvocationTargetException {
           ...
           for ( int i=0;i<numres;i++) {
               ...
               if (autodelete.equals("set")) {
                   ...
                   if (((sageFavorite != null) && (!SageApi.booleanApi("IsAutoDelete", new Object[]{sageFavorite}))) ||
                       ...
                       (SageApi.booleanApi("IsLibraryFile", new Object[]{sageAiring})))
                   {
                       newSearchResults=SageApi.Api("DataUnion",new Object[]{
                               newSearchResults,
                               sageAiring
        ...
        if ( partials.equals("none") )
           searchResults=SageApi.Api("FilterByBoolMethod",new Object[]{searchResults,"IsCompleteRecording", Boolean.TRUE});
