...
public class Channel {
    ...
    public class Image {
        ...
        public Image(String url, String title, String link, int width,
            ...
            if(width <= 0 || width > MAX_WIDTH)
                throw new InvalidRequiredParamException("width must be between 1 and "+MAX_WIDTH+": "+width);
            if(height <= 0 || height > MAX_HEIGHT)
                throw new InvalidRequiredParamException("height must be between 1 and "+MAX_HEIGHT+": "+height);
     ...
     * @author Henrique A. Viecili
     */
    public class Category extends viecili.jrss.generator.elem.Category {
